    ...
    public function sendfarmmail(Request $request, $type)
    {
        ...
        foreach ($users as $user)
        {
            ...
            $emailcontent = array(
                ...
                'kiem_nhiem' => $user->kiem_nhiem,
                'ho_tro_chua_thuong' => $user->ho_tro_chua_thuong,
                ...
                'tien_kiem_nhiem' => $user->tien_kiem_nhiem,
                'tien_ho_tro_chua_thuong' => $user->tien_ho_tro_chua_thuong,
            ...
            if(!empty($data) && $data->count()){
                ...
                foreach ($data->toArray() as $key => $value) {
                    ...
                    $insert[] = [
                        ...
                        'kiem_nhiem' => $value['kiem_nhiem'],
                        'ho_tro_chua_thuong' => $value['ho_tro_chua_thuong'],
                        ...
                        'tien_kiem_nhiem' => $value['tien_kiem_nhiem'],
                        'tien_ho_tro_chua_thuong' => $value['tien_ho_tro_chua_thuong'],
